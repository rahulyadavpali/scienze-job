                                        ...
                                        <div class="row">
                                            <?php if(Auth::user() !== null){
                                                if($user->job_id == 2){
                                                    $matchFound = false;
                                                    foreach ($job as $jobs){
                                                        if($user_detail->subcategories1 == $jobs->subcategories || $user_detail->subcategories2 == $jobs->subcategories || $user_detail->subcategories3 == $jobs->subcategories || $user_detail->subcategories4 == $jobs->subcategories || $user_detail->subcategories5 == $jobs->subcategories)
                                                        {
                                                            $matchFound = true;
                                            ?>
                                                ...
                                                <?php   }
                                                    ...
                                                    if(!$matchFound){echo 'Currently No Jobs For You.';}
                                            ...
                                            {{-- Pagination --}}
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="pager_wrapper gc_blog_pagination custom_pagination">
                                                    {!! $job->appends(Request::all())->links() !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="list" class="tab-pane fade">
                                        ...
                                        ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                <div class="jp_job_post_right_btn_wrapper">
                                                                    <ul>
                                                                        <!-- <li class="jb_fav_right"><a href="javascript:void(0)"><i class="fa fa-heart"></i></a></li> -->
                                                                        <?php if(Auth::user() !== null ){ ?>
                                                                            <li><a href="{{ url('/job-view',[$jobs->id]) }}">Apply</a></li>
                                                                        <?php }else{ ?>
                                                                            <li><a href="{{ url('/user-login') }}">Apply</a></li>
                                            ...
                                            <?php   }
                                                ...
                                                if(!$matchFound){echo 'Match Not Found';}
                                            }
                                            else{foreach ($job as $jobs){ ?>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="jp_job_post_main_wrapper_cont jp_job_post_grid_main_wrapper_cont">
