                                ...
                                <div class="tab-pane fade in active register_left_form" id="contentOne-1">
                                    ...
                                    <div class="row">
                                        <form id="posting_form" class="job_posting_form" method="POST" enctype="multipart/form-data" action="{{ route('auth.employer.review.store') }}">
                                            ...
                                            <input type="hidden" name="logo" id="logo" value="{{ $rev_detail->company_logo }}" />
                                            <input type="hidden" name="role_type" id="role_type" value="1" />
                                            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <label for="company_name">Institute/Orgnization</label>
                                                <input type="text" name="company_name" id="company_name" value="{{ $rev_detail->company_name }}" readonly />
                                            </div>
                                            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
