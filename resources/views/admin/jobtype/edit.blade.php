...
@section('content')
    <h3 class="page-title">Edit Job Designation</h3>
    <div class="main_divs">
        {!! Form::model($job, ['method' => 'PUT', 'route' => ['admin.jobtype.update', $job->id], 'files'=>true,]) !!}
        <div class="panel-default">
            <div class="panel-heading">Create</div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 form-group">
                        {!! Form::label('title', 'Edit Title', ['class' => 'control-label']) !!}
